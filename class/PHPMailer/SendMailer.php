...
class Mailer
{
    public static $HOST = 'smtpdm.aliyun.com'; // 邮箱的服务器地址
    public static $PORT = 465; // smtp 服务器的远程服务器端口号 大部分服务商常规 25 ssl:465
    public static $SMTP = 'ssl'; // 使用 ssl 加密方式登录
    public static $CHARSET = 'UTF-8'; // 设置发送的邮件的编码

    private static $USERNAME = 'test@test.****.com'; // 授权登录的账号，若非域名邮箱，填写邮箱号即可
    private static $PASSWORD = '*********'; // 授权登录的密码
    private static $NICKNAME = '山樱'; // 发件人的昵称
